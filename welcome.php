...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    if (authenticateUser($username, $password)) {
        // Retrieve the user's role from your database based on their username
        $userRole = getUserRoleFromDatabase($username); 

        // Set the 'role' session variable
        $_SESSION['role'] = $userRole;

        // Redirect to a protected page or the user dashboard
...
if ($userRole === 'senior_manager' || $userRole === 'department_manager') {
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            if (isset($_GET['search'])) {
                ...
                // Add the WHERE clause for the search condition with the table alias
            ...
            $sqlCount = "SELECT COUNT(*) FROM staff";

            // Modify the SQL query based on user role
            if (!($userRole === 'senior_manager' || $userRole === 'department_manager')) {
                $sqlCount .= " WHERE Team_leader='$username'";
            }
...
<!-- JavaScript and HTML code for the charts and toggle buttons-->
<div id="chartContainer" style="display: none;">
    <div class="chart-container" style="width: 60%;">
        <canvas id="teamPerformanceChart1"></canvas>
    </div>
    <div class="chart-container" style="width: 40%;">
        <canvas id="technologySumChart"></canvas>
    </div>
</div>
<div class="container">
    <div class="row justify-content-center">
        ...
        new Chart(ctx1, {
            ...
            options: {
                scales: {
                    y: {
                        beginAtZero: true,
                        max: 70, // Customize the maximum value on the y-axis
                    }
                },
                responsive: true,
